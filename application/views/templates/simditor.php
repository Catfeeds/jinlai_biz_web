<?php $simditor_base_url = CDN_URL. 'simditor/v2.3.13'  ?>

<link rel=stylesheet media=all href="<?php echo $simditor_base_url ?>/simditor.css">
<style>
    .simditor-toolbar * {font-size:16px;z-index:auto}
</style>
