        ...
        <div class=params data-type="物流配送">
            ...
            <fieldset>
                ...
                <div class=form-group>
                    ...
                    <div class=col-sm-10>
                        <input class=form-control name=unit_amount type=number step=1 max=9999 value="<?php echo $item['unit_amount'] ?>" placeholder="最高9999">
                    </div>
                </div>
                <div class=form-group>
                    <label for=fee_start class="col-sm-2 control-label">首量运费（元）</label>
                    <div class=col-sm-10>
                        <input class=form-control name=fee_start type=number step=1 max=999 value="<?php echo $item['fee_start'] ?>" placeholder="最高999">
                    </div>
                </div>
                <div class=form-group>
                    <label for=fee_unit class="col-sm-2 control-label">续量运费（元/续量）</label>
                    <div class=col-sm-10>
                        <input class=form-control name=fee_unit type=number step=1 max=999 value="<?php echo $item['fee_unit'] ?>" placeholder="最高999">
                    </div>
                </div>
                <div class=form-group>
                ...
                <div class=form-group>
                    ...
                    <div class=col-sm-10>
                        <input class=form-control name=exempt_subtotal type=number step=1 max=9999 value="<?php echo $item['exempt_subtotal'] ?>" placeholder="最高9999">
