	...
	?>
		<fieldset>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=time_start type=datetime value="<?php echo date('Y-m-d H:i:s', $item['time_start']) ?>" placeholder="例如：<?php echo date('Y-m-d H:i:s', strtotime('+2days')) ?>" required>
				</div>
			</div>
			<div class=form-group>
				<label for=time_end class="col-sm-2 control-label">结束时间※</label>
				<div class=col-sm-10>
					<input class=form-control name=time_end type=datetime value="<?php echo date('Y-m-d H:i:s', $item['time_end']) ?>" placeholder="例如：<?php echo date('Y-m-d H:i:s', strtotime('+5days')) ?>" required>
				</div>
			</div>
			<div class=form-group>
		...
		<fieldset class=params date-type="单品预售">
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=time_book_start type=datetime value="<?php echo date('Y-m-d H:i:s', $item['time_book_start']) ?>" placeholder="例如：<?php echo date('Y-m-d H:i:s', strtotime('+2days')) ?>">
				</div>
			</div>
			<div class=form-group>
				<label for=time_book_end class="col-sm-2 control-label">支付预付款结束时间</label>
				<div class=col-sm-10>
					<input class=form-control name=time_book_end type=datetime value="<?php echo date('Y-m-d H:i:s', $item['time_book_end']) ?>" placeholder="例如：<?php echo date('Y-m-d H:i:s', strtotime('+5days')) ?>">
				</div>
			</div>
			<div class=form-group>
				<label for=time_complete_start class="col-sm-2 control-label">支付尾款开始时间</label>
				<div class=col-sm-10>
					<input class=form-control name=time_complete_start type=datetime value="<?php echo date('Y-m-d H:i:s', $item['time_complete_start']) ?>" placeholder="例如：<?php echo date('Y-m-d H:i:s', strtotime('+10days')) ?>">
				</div>
			</div>
			<div class=form-group>
				<label for=time_complete_end class="col-sm-2 control-label">支付尾款结束时间</label>
				<div class=col-sm-10>
					<input class=form-control name=time_complete_end type=datetime value="<?php echo date('Y-m-d H:i:s', $item['time_complete_end']) ?>" placeholder="例如：<?php echo date('Y-m-d H:i:s', strtotime('+15days')) ?>">
				</div>
			</div>
		</fieldset>
