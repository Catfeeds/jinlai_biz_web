	...
	?>
		...
		<fieldset>
			...
			<div class=form-group>
                ...
                <div class=col-sm-10>
                    <div class=input-group>
                        ...
                        <input class=form-control name=amount type=number step=1 min=0 max=999 value="<?php echo $item['amount'] ?>" placeholder="最高999">
                    </div>
            ...
            <div class=form-group>
                ...
                <div class=col-sm-10>
                    <div class=input-group>
                        <input class=form-control name=rate type=number step=1 min=0 max=50 value="<?php echo $item['rate']*100 ?>" placeholder="最高50">
                        <div class="input-group-addon">%</div>
                    </div>
