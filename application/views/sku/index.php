...
<div id=content class=container>
    ...
    <div id=primary_actions class=action_bottom>
        ...
        <ul class=horizontal>
            <li>
                <a class=bg_primary title="创建<?php echo $this->class_name_cn ?>" href="<?php echo base_url($this->class_name.'/create?item_id='.$comodity['item_id']) ?>"><i class="far fa-plus"></i></a>
            </li>
        </ul>
    </div>
	<?php endif ?>
            ...
            <li>
                ...
                <div class=item-actions>
                    ...
                    <ul class=horizontal>
                        ...
                        if ( in_array($current_role, $role_allowed) && ($current_level >= $level_allowed) ):
                            ?>
                        <li><a href="<?php echo base_url($this->class_name.'/duplicate?id='.$item[$this->id_name]) ?>" target=_blank>复制</a></li>
