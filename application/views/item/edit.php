	...
	?>
		...
		<fieldset>
			...
			<div class=form-group>
                ...
                <div class="input-group col-sm-10">
                    <div class="input-group-addon">￥</div>
                    <input class=form-control name=settle_price type=number min=0.0 step=0.01 max=99999.99 value="<?php echo empty(set_value('settle_price'))? $item['settle_price']: set_value('settle_price') ?>">
				</div>
			</div>
		</fieldset>
		...
		<fieldset>
			...
			<div class=form-group>
                ...
                <div class=col-sm-10>
                    <div class=input-group>
                        <input class=form-control name=allow_sold type=number min=0 step=1 max=65535 value="<?php echo $item['allow_sold']?>">
                    </div>
                </div>
            </div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=quantity_max type=number min=0 step=1 max=99 value="<?php echo empty(set_value('quantity_max'))? $item['quantity_max']: set_value('quantity_max') ?>" placeholder="留空则默认为99，最高99">
				</div>
			</div>
			<div class=form-group>
