				...
				<tr>
					...
					<td>
						<ul class=list-unstyled>
							...
							<li><a title="上架" href="<?php echo base_url($this->class_name.'/publish?ids='.$item[$this->id_name]) ?>" target=_blank><i class="fa fa-level-up"></i> 上架</a></li>
							<?php else: ?>
							<li><a title="下架" href="<?php echo base_url($this->class_name.'/suspend?ids='.$item[$this->id_name]) ?>" target=_blank><i class="fa fa-level-down"></i> 下架</a></li>
							<?php endif ?>
