...
<div id=content class=container>
    <table class="table table-striped table-condensed table-responsive">
        ...
        <?php foreach ($items as $item): ?>
            <tr>
                ...
                endforeach;
                ?>
                <td><?php echo $item['total_approved'] ?></td>
            </tr>
        <?php endforeach ?>
        </tbody>
    </table>
    ...
    <fieldset>
        ...
        <div class=form-group>
            ...
            <div class=col-sm-10>
                <textarea class=form-control name=note_stuff row=5 placeholder="如有必要，可进行备注，最多255个字符" autofocus><?php echo $item['note_stuff'] ?></textarea>
            </div>
        </div>
