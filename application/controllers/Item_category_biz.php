<?php
	...
	{	
		...
		protected $names_to_sort = array(
			'category_id', 'system_category_id', 'parent_id', 'biz_id', 'name', 'url_image',
		...
		protected $names_edit_allowed = array(
			'category_id', 'system_category_id', 'parent_id', 'name', 'url_image',
		);
		...
		public function detail()
		{
			...
			if ($result['status'] === 200):
				...
				// 获取系统商品分类信息
				$data['category'] = $this->get_category($data['item']['system_category_id']);
...
// 			$this->basic->permission_check($role_allowed, $min_level);
			...
			$this->form_validation->set_rules('system_category_id', '所属系统商品分类', 'trim|required');
