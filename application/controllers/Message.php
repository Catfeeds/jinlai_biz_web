<?php
	...
	{	
		...
		protected $names_to_sort = array(
			'message_id', 'user_id', 'biz_id', 'stuff_id', 'from_type', 'to_type', 'type', 'content', 'url_image', 'item_id', 'order_id', 'url_page', 'title', 'time_create', 'time_delete', 'time_edit', 'operator_id',, 'sth_min', 'sth_max',
		);
...
// 			$this->basic->permission_check($role_allowed, $min_level);
			...
			$this->form_validation->set_rules('message_id', '消息ID', 'trim|required');
